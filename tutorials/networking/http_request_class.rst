...
The :ref:`HTTPRequest <class_HTTPRequest>` node is the easiest way to make HTTP requests in redot.
...
.. tabs::
    ...
    .. code-tab:: csharp
        ...
        public partial class MyNode : Node
        {
            ...
            {
                redot.Collections.Dictionary json = Json.ParseString(Encoding.UTF8.GetString(body)).AsredotDictionary();
                GD.Print(json["name"]);
            }
        }
...
.. tabs::
    ...
    .. code-tab:: csharp
        ...
        HttpRequest httpRequest = GetNode<HttpRequest>("HTTPRequest");
        httpRequest.Request("https://api.github.com/repos/redotengine/redot/releases/latest", new string[] { "User-Agent: YourCustomUserAgent" });
