...
.. note:: This chapter relates to the Blender plugin called "redot Blender Exporter",
          which can be downloaded here: https://github.com/redotengine/redot-blender-exporter

This plugin can be used to export Blender scenes in a redot-specific scene format
...
Python function ``io_scene_redot.export(out_file_path)`` that can be called to
...
are present in the
`redot-blender-exporter repository <https://github.com/redotengine/redot-blender-exporter>`__.
