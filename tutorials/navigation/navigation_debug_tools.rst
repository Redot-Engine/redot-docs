...
.. note::
    ...
    The debug tools, properties and functions are only available in redot debug builds.
...
In redot debug builds the navigation debug can also be toggled through the NavigationServer singletons from scripts.
