...
.. seealso::
    ...
    `Run-time File Saving and Loading (Serialization) demo project <https://github.com/redotengine/redot-demo-projects/blob/master/loading/runtime_save_load>`__.

Plain text and binary files
---------------------------

redot's :ref:`class_FileAccess` class provides methods to access files on the
...
redot), :ref:`class_FileAccess` provides several methods to read/write integers,
...
redot's support for :ref:`doc_using_fonts_system_fonts`.
...
redot supports reading and writing ZIP archives using the :ref:`class_zipreader`
