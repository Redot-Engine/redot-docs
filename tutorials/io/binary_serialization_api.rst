...
packet. Note that this assumes redot is compiled with single-precision floats,
which is the default. If redot was compiled with double-precision floats, the
