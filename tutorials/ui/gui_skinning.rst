...
The default redot theme comes with multiple theme types already defined,
...
Out of the box each project adopts the default project theme provided by redot. The
