...
redot supports both :ref:`Vector2 <class_Vector2>` and :ref:`Vector3
...
With redot, you can use the built-in :ref:`Vector3.cross() <class_Vector3_method_cross>`
method:
