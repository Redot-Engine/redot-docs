...
.. image:: img/matrices_and_transforms/identity-redot.png
...
.. note:: redot represents all rotations with radians, not degrees.
...
.. note:: Fun fact: In addition to Y being *down* in redot, rotation
...
Note that in 3D, redot has a separate :ref:`class_Basis` structure
...
.. note:: redot's 2D uses coordinates based on pixels, so in actual
...
.. note:: In redot, all transform math is done relative to the parent node.
...
axis is of type :ref:`class_Vector3`, and also that redot stores
...
https://github.com/redotengine/redot-demo-projects/tree/master/misc/matrix_transform

.. note:: You cannot edit Node2D's transform matrix directly in redot 4.0's
