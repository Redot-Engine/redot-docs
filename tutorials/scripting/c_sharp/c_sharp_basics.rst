...
- Install the **redot support** plugin.
...
.. note:: If you see an error like "Unable to find package redot.NET.Sdk",
...
`issue tracker for .NET issues <https://github.com/redotengine/redot/labels/topic%3Adotnet>`_.
...
According to some preliminary `benchmarks <https://github.com/cart/redot3-bunnymark>`_,
the performance of C# in redot — while generally in the same order of magnitude
...
`NuGet <https://www.nuget.org/>`_ packages can be installed and used with redot,
