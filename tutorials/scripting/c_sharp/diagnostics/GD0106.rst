...
redot doesn't allow exporting explicit interface property implementations.
...
can't be exported so they will be ignored by redot, resulting in runtime errors.
