...
.. seealso:: Under the hood, these functions rely on redot's low-level
...
To learn more about inputs in redot, see the :ref:`Input section <toc-learn-features-inputs>`.
