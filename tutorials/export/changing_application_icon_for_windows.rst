...
external tools using `redoticon <https://github.com/pkowal1982/redoticon>`__.
Changing the file icon this way should work for executables containing
an embedded PCK.

.. warning::

    There are `known issues <https://github.com/redotengine/redot/issues/33466>`__
...
.. note::
    ...
    `platform/windows/redot.ico <https://github.com/redotengine/redot/blob/master/platform/windows/redot.ico>`__
