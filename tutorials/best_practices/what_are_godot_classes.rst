...
Still, many best practices using redot involve applying object-oriented programming principles to
...
redot's internal classes have methods that register a class's data with a :ref:`ClassDB
