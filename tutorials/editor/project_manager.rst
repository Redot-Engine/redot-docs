...
.. note:: You can optionally choose a version control system. Currently, only 
	...
	either manually or using the :ref:`Asset Library <doc_using_assetlib>`. To learn more about the redot Git Plugin, see its `wiki <https://github.com/redotengine/redot-git-plugin/wiki>`__.

Using the file browser
~~~~~~~~~~~~~~~~~~~~~~

Click the **Browse** button to open redot's file browser.
