...
mappings_unimplemented = [
    ...
    (
        ...
        "https://hosted.weblate.org/projects/redot-engine/redot-docs",
    ),
    ...
    (
        ...
        "https://flathub.org/apps/details/org.redot-engine.Redot",
    ),
    ("https://godot.foundation", "https://redot.foundation"),
    (
        "https://hosted.weblate.org/projects/godot-engine/godot/",
        "https://hosted.weblate.org/projects/redot-engine/redot/",
    ),
...
mappings = [
    ...
    (
        ...
        "https://download.redotengine.org/docs/redot-docs-html-stable.zip",
    ),
    (
        "https://nightly.link/godotengine/godot-docs/workflows/build_offline_docs/master/godot-docs-html-master.zip",
        "https://download.redotengine.org/docs/redot-docs-html-master.zip",
    ),
    (
        "https://nightly.link/godotengine/godot-docs/workflows/build_offline_docs/master/godot-docs-epub-stable.zip",
        "https://download.redotengine.org/docs/redot-docs-epub-stable.zip",
    ),
    (
        "https://nightly.link/godotengine/godot-docs/workflows/build_offline_docs/master/godot-docs-epub-master.zip",
        "https://download.redotengine.org/docs/redot-docs-epub-master.zip",
    ),
    # Table breakers
    (
        '| ``"Please include this when reporting the bug on: https://github.com/godotengine/godot/issues"`` |',
        '| ``"Please include this when reporting the bug on: https://github.com/redot-engine/godot/issues"``|',
    ),
    (
        "https://github.com/godotengine/godot/pull/40364>`_ for more.     |",
        "https://github.com/redot-engine/redot/pull/40364>`_ for more.    |",
    ),
    ...
    (
        "https://nightly.link/godotengine/godot-docs/workflows/build_offline_docs/master/godot",
        "https://nightly.link/redot-engine/redot-docs/workflows/build_offline_docs/master/redot",
    ),
    ...
    (
        "https://raw.githubusercontent.com/godotengine/godot/master",
        "https://raw.githubusercontent.com/redot-engine/redot-engine/master",
    ),
    ...
    (
        "https://raw.githubusercontent.com/godotengine/godot-docs",
        "https://raw.githubusercontent.com/redot-engine/redot-docs",
    ),
    ...
    (
        ...
        '{% set listed_languages = ({"en":"#"}).items() -%}',
    ),
    ('({"stable":"#", "latest":"#"})', '({"stable":"/en/stable", "latest":"/en/latest"})'),
    (
        'Hosted by <a href="https://readthedocs.org">Read the Docs',
        'Hosted by <a href="https://cloudflare.com">CloudFlare',
    ),
...
def main():
    ...
    parser.add_argument(
        "-e", "--extended", action="store_true", help="Include unimplemented substitutions, don't use in production"
    )
    parser.add_argument("-x", "--exclude-classes", action="store_true", help="Exclude classes directory")
