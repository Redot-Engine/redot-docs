...
following:
  ...
  1. A contributor opens a PR that fixes a specific problem (optimally closing
     a GitHub `issue <https://github.com/redotengine/redot>`_ or implementing
     a `proposal <https://github.com/redotengine/redot-proposals>`_).
...
on GitHub and/or are listed on the `Teams page <https://redotengine.org/teams>`_
...
.. note::
    ...
    <https://github.com/redotengine/redot/pulls?q=is%3Apr+is%3Aopen+review%3Aapproved+sort%3Aupdated-desc>`_.
...
* **Check for proper commit messages.**
  ...
  <https://github.com/redotengine/redot/blob/master/CONTRIBUTING.md#format-your-commit-messages-with-readability-in-mind>`_
