...
redot's `MIT <https://tldrlegal.com/license/mit-license>`_ license grants you,
...
`redot's source code <https://github.com/redotengine/redot>`_, and send those
...
`good first issue <https://github.com/redotengine/redot/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22>`_
on GitHub.
...
has a `proposal system <https://github.com/redotengine/redot-proposals>`_. Its
usage is encouraged to plan changes and discuss them with the community. Implementation
details can also be discussed with other contributors on the `redot Contributors Chat <https://chat.redotengine.org/>`_.
...
redot uses `GitHub's issue tracker <https://github.com/redotengine/redot/issues>`_
...
- **The tutorials and engine documentation and its translations.**
  ...
  `redot-docs <https://github.com/redotengine/redot-docs>`_ GitHub repository.
