...
with a redot build that includes code from the pull request in question.

Thanks to GitHub Actions, all `pull requests <https://github.com/redotengine/redot/pulls>`__
...
by redot's GitHub Actions setup.
