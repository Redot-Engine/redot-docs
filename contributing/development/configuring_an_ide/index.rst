...
We assume that you have already `cloned <https://github.com/redotengine/redot>`_
and :ref:`compiled <toc-devel-compiling>` redot.

You can easily develop redot with any text editor and by invoking ``scons``
