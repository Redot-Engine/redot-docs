...
Thanks for your interest in contributing to the redot editor!

This page describes the grammar and writing style used throughout the redot
...
some examples taken from the redot editor:
