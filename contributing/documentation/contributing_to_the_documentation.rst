...
<https://github.com/redotengine/redot-docs>`_. Modifying those pages in a pull
...
.. warning:: The class reference's source files are in the `redot engine
             repository <https://github.com/redotengine/redot>`_. We generate
...
reference <https://github.com/redotengine/redot/tree/master/doc/classes>`__.
...
1. Look for `existing issues
   <https://github.com/redotengine/redot-docs/issues>`_ or open a new one to see
...
Consider using the `redot-docs-project-starters <https://github.com/redotengine/redot-docs-project-starters>`
...
.. code:: rst
   ...
   `file_name.zip <https://github.com/redotengine/redot-docs-project-starters/releases/download/latest-4.x/file_name.zip>`_
