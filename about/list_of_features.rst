...
- Linux (x86 and ARM, 64-bit and 32-bit).
   ...
   - Official binaries are compiled using the
     `redot Engine buildroot <https://github.com/redotengine/buildroot>`__,
...
- Official GDExtension bindings for `C <https://github.com/redotengine/redot-headers>`__
  and `C++ <https://github.com/redotengine/redot-cpp>`__.

   - Use any build system and language features you wish.

- Actively developed GDExtension bindings for `D <https://github.com/redot-dlang/redot-dlang>`__,
  `Haxe <https://hxredot.github.io/>`__, `Swift <https://github.com/migueldeicaza/Swiftredot>`__, and `Rust <https://github.com/redot-rust/gdextension>`__
...
- *3D scenes:* See :ref:`doc_importing_3d_scenes`.
   ...
   - FBX (by calling `FBX2glTF <https://github.com/redotengine/FBX2glTF>`__ transparently).
   - Collada (.dae).
...
- :ref:`Command line interface <doc_command_line_tutorial>` for automation.
   ...
   - `Shell completion scripts <https://github.com/redotengine/redot/tree/master/misc/dist/shell>`__
...
.. seealso::
    ...
    The `redot proposals repository <https://github.com/redotengine/redot-proposals>`__
