...
.. note::
    ...
    like FBX, which redot also supports. To produce these files, we designed the
...
arrow keys. In redot, while we could write all the key bindings in code, there's
...
redot projects come with some predefined actions designed for user interface
