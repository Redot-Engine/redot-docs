...
In :ref:`doc_key_concepts_overview`, we saw that a redot game is a tree of
...
.. note:: The editor saves the main scene's path in a project.redot file in your
