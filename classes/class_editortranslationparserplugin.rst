...
.. XML source: https://github.com/redotengine/redot/tree/master/doc/classes/EditorTranslationParserPlugin.xml.
...
.. tabs::
 ...
 .. code-tab:: csharp
    ...
    {
        public override void _ParseFile(string path, redot.Collections.Array<string> msgids, redot.Collections.Array<redot.Collections.Array> msgidsContextPlural)
        {
...
.. tabs::
 ...
 .. code-tab:: csharp
    ...
    // This will add a message with msgid "Test 1", msgctxt "context", and msgid_plural "test 1 plurals".
    msgidsContextPlural.Add(new redot.Collections.Array{"Test 1", "context", "test 1 Plurals"});
    // This will add a message with msgid "A test without context" and msgid_plural "plurals".
    msgidsContextPlural.Add(new redot.Collections.Array{"A test without context", "", "plurals"});
    // This will add a message with msgid "Only with context" and msgctxt "a friendly context".
    msgidsContextPlural.Add(new redot.Collections.Array{"Only with context", "a friendly context", ""});
