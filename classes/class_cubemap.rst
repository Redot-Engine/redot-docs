...
.. XML source: https://github.com/Redot-Engine/redot-engine/tree/4.3/doc/classes/Cubemap.xml.
...
\ **Note:** Redot doesn't support using cubemaps in a :ref:`PanoramaSkyMaterial<class_PanoramaSkyMaterial>`. You can use `this tool <https://danilw.github.io/GLSL-howto/cubemap_to_panorama_js/cubemap_to_panorama.html>`__ to convert a cubemap to an equirectangular sky map.
