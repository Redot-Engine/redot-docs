...
.. XML source: https://github.com/redotengine/redot/tree/master/doc/classes/EditorImportPlugin.xml.
...
.. tabs::
 ...
 .. code-tab:: csharp
    ...
    public partial class MySpecialPlugin : EditorImportPlugin
    {
        ...
        public override redot.Collections.Array<redot.Collections.Dictionary> _GetImportOptions(string path, int presetIndex)
        {
...
.. tabs::
 ...
 .. code-tab:: csharp
    ...
    public void _GetOptionVisibility(string option, redot.Collections.Dictionary options)
    {
        // Only show the lossy quality setting if the compression mode is set to "Lossy".
...
Gets the extension used to save this resource in the ``.redot/imported`` directory (see :ref:`ProjectSettings.application/config/use_hidden_project_data_directory<class_ProjectSettings_property_application/config/use_hidden_project_data_directory>`).
