...
.. XML source: https://github.com/redotengine/redot/tree/master/doc/classes/EditorScriptPicker.xml.
...
redot editor's control for selecting the ``script`` property of a :ref:`Node<class_Node>`.
