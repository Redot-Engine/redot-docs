...
.. XML source: https://github.com/Redot-Engine/redot-engine/tree/4.3/doc/classes/EditorSettings.xml.
...
- **Redot** Middle mouse button to orbit, :kbd:`Shift + Middle mouse button` to pan. :kbd:`Mouse wheel` to zoom.
...
All update modes will ignore builds with different major versions (e.g. Godot 4 -> Redot 5).
