...
.. XML source: https://github.com/redotengine/redot/tree/master/doc/classes/EditorSettings.xml.
...
.. tabs::
 ...
 .. code-tab:: csharp
    ...
    redot.Collections.Array<redot.Collections.Dictionary> listOfSettings = settings.GetPropertyList();
...
- **Dark** makes fonts and icons dark (suitable for light themes). Icon colors are automatically converted by the editor following the set of rules defined in `this file <https://github.com/redotengine/redot/blob/master/editor/themes/editor_theme_manager.cpp>`__.
...
\ **Note:** The default editor icon saturation was increased by 30% in redot 4.0 and later. To get redot 3.x's icon saturation back, set :ref:`interface/theme/icon_saturation<class_EditorSettings_property_interface/theme/icon_saturation>` to ``0.77``.
...
The TLS certificate bundle to use for HTTP requests made within the editor (e.g. from the AssetLib tab). If left empty, the `included Mozilla certificate bundle <https://github.com/redotengine/redot/blob/master/thirdparty/certs/ca-certificates.crt>`__ will be used.
...
You can find additional syntax themes to install in the `redot-syntax-themes <https://github.com/redotengine/redot-syntax-themes>`__ repository.
