...
.. table::
   ...
   +----------------------------------------------------------+----------------------------------------------------------------------------+-----------------------+
   | :ref:`bool<class_bool>`                                  | :ref:`display_old_color<class_ColorPicker_property_display_old_color>`     | ``false``             |
   +----------------------------------------------------------+----------------------------------------------------------------------------+-----------------------+
...
.. table::
   ...
   +-----------------------------------+---------------------------------------------------------------------------------------------------------+---------------------------+
   | :ref:`Texture2D<class_Texture2D>` | :ref:`wheel_picker_cursor<class_ColorPicker_theme_icon_wheel_picker_cursor>`                            |                           |
   +-----------------------------------+---------------------------------------------------------------------------------------------------------+---------------------------+
...
.. _class_ColorPicker_property_display_old_color:

.. rst-class:: classref-property

:ref:`bool<class_bool>` **display_old_color** = ``false`` :ref:`🔗<class_ColorPicker_property_display_old_color>`

.. rst-class:: classref-property-setget

- |void| **set_display_old_color**\ (\ value\: :ref:`bool<class_bool>`\ )
- :ref:`bool<class_bool>` **is_displaying_old_color**\ (\ )

If ``true``, :ref:`old_color<class_ColorPicker_property_old_color>` will be displayed instead of :ref:`color<class_ColorPicker_property_color>`.
...
.. _class_ColorPicker_property_old_color:

.. rst-class:: classref-property

:ref:`Color<class_Color>` **old_color** = ``Color(0, 0, 0, 1)`` :ref:`🔗<class_ColorPicker_property_old_color>`

.. rst-class:: classref-property-setget

- |void| **set_old_color**\ (\ value\: :ref:`Color<class_Color>`\ )
- :ref:`Color<class_Color>` **get_old_color**\ (\ )

The currently stored old color. See also :ref:`display_old_color<class_ColorPicker_property_display_old_color>`.
...
.. _class_ColorPicker_theme_icon_wheel_picker_cursor:

.. rst-class:: classref-themeproperty

:ref:`Texture2D<class_Texture2D>` **wheel_picker_cursor** :ref:`🔗<class_ColorPicker_theme_icon_wheel_picker_cursor>`

The image displayed over the color wheel (depending on the :ref:`picker_shape<class_ColorPicker_property_picker_shape>` being :ref:`SHAPE_HSV_WHEEL<class_ColorPicker_constant_SHAPE_HSV_WHEEL>`), marking the currently selected hue. This icon is rotated from the right side of the wheel.
