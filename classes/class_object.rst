...
.. XML source: https://github.com/redotengine/redot/tree/master/doc/classes/Object.xml.
...
- :doc:`Object notifications <../tutorials/best_practices/redot_notifications>`
...
.. tabs::
 ...
 .. code-tab:: csharp
    ...
    public override redot.Collections.Array<redot.Collections.Dictionary> _GetPropertyList()
    {
...
.. tabs::
 ...
 .. code-tab:: csharp
    ...
    public partial class MyNode : Node
    {
        ...
        private redot.Collections.Array<int> _numbers = new();
    
        public override redot.Collections.Array<redot.Collections.Dictionary> _GetPropertyList()
        {
            var properties = new redot.Collections.Array<redot.Collections.Dictionary>();
    
            for (int i = 0; i < _numberCount; i++)
            {
                properties.Add(new redot.Collections.Dictionary()
                {
                    { "name", $"number_{i}" },
                    { "type", (int)Variant.Type.Int },
...
.. tabs::
 ...
 .. code-tab:: csharp
    ...
    private redot.Collections.Dictionary _internalData = new redot.Collections.Dictionary();
...
.. tabs::
 ...
 .. code-tab:: csharp
    ...
    public partial class MyNode : Node
    {
        ...
        public override void _ValidateProperty(redot.Collections.Dictionary property)
        {
...
.. tabs::
 ...
 .. code-tab:: csharp
    ...
    var node = new Node3D();
    node.Callv(Node3D.MethodName.Rotate, new redot.Collections.Array { new Vector3(1f, 0f, 0f), 1.571f });
