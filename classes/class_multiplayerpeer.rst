...
.. XML source: https://github.com/redotengine/redot/tree/master/doc/classes/MultiplayerPeer.xml.
...
\ **Note:** The :ref:`MultiplayerAPI<class_MultiplayerAPI>` protocol is an implementation detail and isn't meant to be used by non-redot servers. It may change without notice.
