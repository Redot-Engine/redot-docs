...
.. XML source: https://github.com/redotengine/redot/tree/master/doc/classes/ResourceImporterTexture.xml.
...
If ``true``, convert the normal map from Y- (DirectX-style) to Y+ (OpenGL-style) by inverting its green color channel. This is the normal map convention expected by redot.
