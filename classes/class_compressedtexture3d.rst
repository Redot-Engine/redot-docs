...
.. XML source: https://github.com/redotengine/redot/tree/master/doc/classes/CompressedTexture3D.xml.
...
**CompressedTexture3D** is the VRAM-compressed counterpart of :ref:`ImageTexture3D<class_ImageTexture3D>`. The file extension for **CompressedTexture3D** files is ``.ctex3d``. This file format is internal to redot; it is created by importing other image formats with the import system.
