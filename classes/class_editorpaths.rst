...
.. XML source: https://github.com/redotengine/redot/tree/master/doc/classes/EditorPaths.xml.
...
\ **Note:** On macOS, quarantine flag should be manually removed before using self-contained mode, see `Running on macOS <https://docs.redotengine.org/en/stable/tutorials/export/running_on_macos.html>`__.
