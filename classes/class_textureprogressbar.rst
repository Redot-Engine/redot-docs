...
.. XML source: https://github.com/redotengine/redot/tree/master/doc/classes/TextureProgressBar.xml.
...
TextureProgressBar works like :ref:`ProgressBar<class_ProgressBar>`, but uses up to 3 textures instead of redot's :ref:`Theme<class_Theme>` resource. It can be used to create horizontal, vertical and radial progress bars.
