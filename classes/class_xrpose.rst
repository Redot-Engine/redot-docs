...
.. XML source: https://github.com/redotengine/redot/tree/master/doc/classes/XRPose.xml.
...
The name of this pose. Usually, this name is derived from an action map set up by the user. redot also suggests some pose names that :ref:`XRInterface<class_XRInterface>` objects are expected to implement:
