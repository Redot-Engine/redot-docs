...
.. XML source: https://github.com/redotengine/redot/tree/master/doc/classes/DisplayServer.xml.
...
Display server supports `Input Method Editor <https://en.wikipedia.org/wiki/Input_method>`__, which is commonly used for inputting Chinese/Japanese/Korean text. This is handled by the operating system, rather than by redot. **Windows, macOS, Linux (X11)**
