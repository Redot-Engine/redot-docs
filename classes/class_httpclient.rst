...
.. XML source: https://github.com/redotengine/redot/tree/master/doc/classes/HTTPClient.xml.
...
.. tabs::
 ...
 .. code-tab:: csharp
    ...
    var fields = new redot.Collections.Dictionary { { "username", "user" }, { "password", "pass" } };
