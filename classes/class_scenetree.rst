...
.. XML source: https://github.com/redotengine/redot/tree/master/doc/classes/SceneTree.xml.
...
Calls :ref:`Object.notification<class_Object_method_notification>` with the given ``notification`` to all nodes inside this tree added to the ``group``. See also :doc:`redot notifications <../tutorials/best_practices/redot_notifications>` and :ref:`call_group<class_SceneTree_method_call_group>` and :ref:`set_group<class_SceneTree_method_set_group>`.
