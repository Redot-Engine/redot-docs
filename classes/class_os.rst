...
.. XML source: https://github.com/Redot-Engine/redot-engine/tree/4.3/doc/classes/OS.xml.
...
- ``OS.shell_open("https://godotengine.org")`` opens the default web browser on the official Redot website.
