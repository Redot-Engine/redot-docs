...
.. XML source: https://github.com/redotengine/redot/tree/master/doc/classes/OS.xml.
...
- ``OS.shell_open("https://redotengine.org")`` opens the default web browser on the official redot website.
