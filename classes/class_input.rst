...
.. XML source: https://github.com/redotengine/redot/tree/master/doc/classes/Input.xml.
...
Returns the name of the joypad at the specified device index, e.g. ``PS4 Controller``. redot uses the `SDL2 game controller database <https://github.com/gabomdq/SDL_GameControllerDB>`__ to determine gamepad names.
