...
.. XML source: https://github.com/Redot-Engine/redot-engine/tree/master/doc/classes/CompressedCubemap.xml.
...
A cubemap that is loaded from a ``.ccube`` file. This file format is internal to Redot; it is created by importing other image formats with the import system. **CompressedCubemap** can use one of 4 compression methods:
