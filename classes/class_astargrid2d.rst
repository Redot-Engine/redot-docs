...
.. table::
   ...
   +----------------------------------------------------+------------------------------------------------------------------------------------------+------------------------+
   | :ref:`int<class_int>`                              | :ref:`max_traversals<class_AStarGrid2D_property_max_traversals>`                         | ``0``                  |
   +----------------------------------------------------+------------------------------------------------------------------------------------------+------------------------+
...
.. _class_AStarGrid2D_property_max_traversals:

.. rst-class:: classref-property

:ref:`int<class_int>` **max_traversals** = ``0`` :ref:`🔗<class_AStarGrid2D_property_max_traversals>`

.. rst-class:: classref-property-setget

- |void| **set_max_traversals**\ (\ value\: :ref:`int<class_int>`\ )
- :ref:`int<class_int>` **get_max_traversals**\ (\ )
