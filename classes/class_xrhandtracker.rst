...
.. XML source: https://github.com/redotengine/redot/tree/master/doc/classes/XRHandTracker.xml.
...
A hand tracking system will create an instance of this object and add it to the :ref:`XRServer<class_XRServer>`. This tracking system will then obtain skeleton data, convert it to the redot Humanoid hand skeleton and store this data on the **XRHandTracker** object.
